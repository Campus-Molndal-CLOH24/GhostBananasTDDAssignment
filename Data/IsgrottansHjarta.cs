...
public class IsgrottansHjarta : Room
{
    public IsgrottansHjarta()
    {
        ...
        Items = new List<Item>
        {
            new("Islyktan", "En vackert uthuggen lykta av is, den enda ljuskällan i rummet."),
            new("Frostblommor", "Ömtåliga, glittrande isblommor som växer ur golvets sprickor."),
            new("Glasbit", "En skärva av iskristall från väggen, kall och hal i handen."),
            new("Isnyckel", "En nyckel formad av is. Kanske kan den öppna något längre fram.")
        };
    }
}